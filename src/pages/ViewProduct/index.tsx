            ...
            <View style={styles.container}>
                ...
                <View style={styles.summary}>
                    ...
                    <Row style={{ alignItems: 'center', marginVertical: INLINE_GAP - 5 }}>
                        ...
                        <Aicon name="star" color={RED} size={ICON_SIZE} />
                        <Aicon name="star" color={RED} size={ICON_SIZE} />
                        <Text style={{ marginHorizontal: DEFAUTL_SPACE, fontSize: FONT_MID }}>5.0</Text>
                        <Text style={{ fontSize: FONT_MID, color: GREY }}>(48)</Text>
                    </Row>
                ...
                <View style={styles.description}>
                    ...
                    <Row style={{ justifyContent: 'space-between', alignItems: 'center', marginBottom: DEFAUTL_SPACE }}>
                        <Text style={{ fontSize: FONT_MID }}>Weight</Text>
                        <Text style={{ fontSize: FONT_MID }}>1.5kg</Text>
                    </Row>
                    <Row style={{ justifyContent: 'space-between', alignItems: 'center', marginBottom: DEFAUTL_SPACE }}>
                        <Text style={{ fontSize: FONT_MID }}>Sold</Text>
                        <Text style={{ fontSize: FONT_MID }}>500 product</Text>
                    </Row>
                    <Row style={{ justifyContent: 'space-between', alignItems: 'center', marginBottom: DEFAUTL_SPACE }}>
                        <Text style={{ fontSize: FONT_MID }}>Brand</Text>
                        <Text style={{ fontSize: FONT_MID }}>Miglar</Text>
                    </Row>
                    <Row style={{ justifyContent: 'space-between', alignItems: 'center', marginBottom: DEFAUTL_SPACE }}>
                        <Text style={{ fontSize: FONT_MID }}>Stock</Text>
                        <Text style={{ fontSize: FONT_MID }}>{`>1156`}Available</Text>
                    </Row>
                    <Hr style={{ marginBottom: DEFAUTL_SPACE }} />
                    <View style={{ flexDirection: 'column' }}>
                        <Text style={[styles.heading, { marginBottom: DEFAUTL_SPACE / 2 }]}>Product Information :</Text>
                        <Text style={{ fontSize: FONT_MID, color: GREY }}>This shirt is great for everyday wear for young and old alike. so that you do not have trouble washing it ...</Text>
                    </View>
                </View>
                <View style={styles.reviews}>
                    ...
                    <Row style={{ justifyContent: 'space-between', alignItems: 'center', marginVertical: DEFAUTL_SPACE }}>
                        <Text style={{ fontSize: FONT_MID }}>Suggestions Products</Text>
                        <TouchableOpacity onPress={() => { props.navigation.push("ProductPage", { type: "Products" }) }}>
                            <Text style={{ fontSize: FONT_SMALL }}>View all</Text>
                        </TouchableOpacity>
                    </Row>
        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: INLINE_GAP, alignItems: 'center' }}>
                <Row style={{ justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Text style={{ fontSize: FONT_SMALL, marginRight: DEFAUTL_SPACE, color: GREY }}>20% off</Text>
                </Row>
